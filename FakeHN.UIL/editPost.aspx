<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editPost.aspx.cs" Inherits="FakeHN.UIL.edit" %>
        ...
        <div class="card text-center mx-5 login-card my-5">
            ...
            <div class="card-body">
                <div class="container-fluid d-flex justify-content-center align-align-items-center my-5 w-100 h-100">
                    <form class="w-100" id="editPostForm" runat="server">
                      <textarea id="editPostTextArea" runat="server" class="d-block mb-2 w-100" style="flex: 0 0 100%; height:100px" required></textarea>
                        <asp:Button runat="server" Text="Save" OnClick="SaveEditsButtonClick" />
                    </form>
                 </div>
                  <div id="editPostResult" class="card-footer text-muted" runat="server">
                  </div>
            </div>
        </div>
    </main>
