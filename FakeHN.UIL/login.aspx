                ...
                <div class="container-fluid d-flex justify-content-center align-align-items-center my-5 w-100 h-100">
                    <form id="loginForm" runat="server">
                      <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" id="loginFormUsername" placeholder="Username" required="" runat="server"/>
                      </div>
                      <div class="form-group mb-2">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" id="loginFormPassword" placeholder="Password" required="" runat="server"/>
                      </div>
                      <asp:Button type="submit" class="btn btn-primary" runat="server" OnClick="LoginButtonClick" Text="Login"></asp:Button>
                    </form>
                 </div>
