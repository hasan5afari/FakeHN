      ...
      <nav class="navbar navbar-light bg-light navbar-expand-sm">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse me-auto" id="navigationBar">
            ...
            <div id="panelUserINFO" runat="server" class="container d-inline-flex align-items-center justify-content-center justify-content-sm-end"></div>
          </div>
        </div>
      </nav>
                ...
                <div class="card-body">
                     <div class="container-fluid d-flex justify-content-center align-align-items-center mt-3 mb-3 w-100 h-100">
                         <table class="table table-striped">
                            <div id="panelContent" runat="server"></div>
                         </table>
                     </div>
